...
class grapher(mathbase):
    ...
    def fresh(self, top=True):
        ...
        self.e.makevars({
            ...
            "cum":funcfloat(self.cumcall, "cum"),
            "inv":funcfloat(self.invcall, "inv"),
            "invcum":funcfloat(self.invcumcall, "invcum"),
            "at":funcfloat(self.atcall, "at"),
            "invat":funcfloat(self.invatcall, "invat"),
            "overlap":funcfloat(self.sectcall, "overlap"),
            "para":funcfloat(self.paracall, "para"),
            "polar":funcfloat(self.polarcall, "polar"),
            "scroll":funcfloat(self.scrollcall, "scroll"),
            "print":funcfloat(self.printcall, "print"),
            "show":funcfloat(self.showcall, "show"),
            "clear":usefunc(self.clear, "clear"),
            "cleargrid":usefunc(self.cleargrid, "cleargrid"),
            "center":usefunc(self.center, "center"),
            "grid":usefunc(self.gridrender, "grid"),
            "ticks":usefunc(self.tickrender, "ticks"),
            "axis":usefunc(self.axisrender, "axis"),
            "origin":usefunc(self.origin, "origin"),
            "render":strfunc("cleargrid(),axis(),ticks()", name="render"),
            "display":strfunc("center(),render()", name="display"),
            "stretch":1.0,
            "xstretch":"stretch",
            "ystretch":"stretch",
            "up":1.0,
