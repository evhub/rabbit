...
class evaluator(object):
    ...
    def __init__(self, variables=None, processor=None, gen=None):
        ...
        self.variables = {
            "type":funcfloat(funcs.typecall, "type"),
            "to":funcfloat(funcs.tocall, "to"),
            "str":funcfloat(funcs.strcall, "str"),
            "repr":funcfloat(funcs.reprcall, "repr"),
            "chars":funcfloat(funcs.charscall, "chars"),
            "calc":funcfloat(funcs.docalc, "calc"),
            "fold":funcfloat(funcs.foldcall, "fold"),
            "D":funcfloat(funcs.derivcall, "D"),
            "S":funcfloat(funcs.integcall, "S"),
            "L":funcfloat(funcs.brackcall, "L"),
            "I":funcfloat(funcs.repeatcall, "I"),
            "list":funcfloat(funcs.listcall, "list"),
            "matrix":funcfloat(funcs.matrixcall, "matrix"),
            "cont":funcfloat(funcs.getmatrixcall, "cont"),
            "det":funcfloat(funcs.detcall, "det"),
            "sum":funcfloat(funcs.sumcall, "sum"),
            "prod":funcfloat(funcs.prodcall, "prod"),
            "join":funcfloat(funcs.joincall, "join"),
            "merge":funcfloat(funcs.mergecall, "merge"),
            "sort":funcfloat(funcs.sortcall, "sort"),
            "reverse":funcfloat(funcs.reversecall, "reverse"),
            "round":funcfloat(funcs.roundcall, "round"),
            "num":funcfloat(funcs.numcall, "num"),
            "eval":funcfloat(funcs.collapsecall, "eval"),
            "find":funcfloat(funcs.findcall, "find"),
            "split":funcfloat(funcs.splitcall, "split"),
            "replace":funcfloat(funcs.replacecall, "replace"),
            "contains":funcfloat(funcs.containscall, "contains"),
            "range":funcfloat(funcs.rangecall, "range"),
            "len":funcfloat(funcs.lencall, "len"),
            "size":funcfloat(funcs.sizecall, "size"),
            "abs":funcfloat(funcs.abscall, "abs"),
            "data":funcfloat(funcs.datacall, "data"),
            "frac":funcfloat(funcs.fractcall, "frac"),
            "simp":funcfloat(funcs.simpcall, "simp"),
