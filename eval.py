...
class evaluator(object):
    ...
    def __init__(self, variables=None, processor=None, gen=None):
        ...
        self.variables = {
            "type":funcfloat(funcs.typecall, "type", self),
            "to":funcfloat(funcs.tocall, "to", self),
            "str":funcfloat(funcs.strcall, "str", self),
            "repr":funcfloat(funcs.reprcall, "repr", self),
            "chars":funcfloat(funcs.charscall, "chars", self),
            "calc":funcfloat(funcs.docalc, "calc", self),
            "fold":funcfloat(funcs.foldcall, "fold", self),
            "D":funcfloat(funcs.derivcall, "D", self),
            "S":funcfloat(funcs.integcall, "S", self),
            "L":funcfloat(funcs.brackcall, "L", self),
            "I":funcfloat(funcs.repeatcall, "I", self),
            "list":funcfloat(funcs.listcall, "list", self),
            "matrix":funcfloat(funcs.matrixcall, "matrix", self),
            "cont":funcfloat(funcs.getmatrixcall, "cont", self),
            "det":funcfloat(funcs.detcall, "det", self),
            "sum":funcfloat(funcs.sumcall, "sum", self),
            "prod":funcfloat(funcs.prodcall, "prod", self),
            "join":funcfloat(funcs.joincall, "join", self),
            "merge":funcfloat(funcs.mergecall, "merge", self),
            "sort":funcfloat(funcs.sortcall, "sort", self),
            "reverse":funcfloat(funcs.reversecall, "reverse", self),
            "round":funcfloat(funcs.roundcall, "round", self),
            "num":funcfloat(funcs.numcall, "num", self),
            "eval":funcfloat(funcs.collapsecall, "eval", self),
            "find":funcfloat(funcs.findcall, "find", self),
            "split":funcfloat(funcs.splitcall, "split", self),
            "replace":funcfloat(funcs.replacecall, "replace", self),
            "contains":funcfloat(funcs.containscall, "contains", self),
            "range":funcfloat(funcs.rangecall, "range", self),
            "len":funcfloat(funcs.lencall, "len", self),
            "size":funcfloat(funcs.sizecall, "size", self),
            "abs":funcfloat(funcs.abscall, "abs", self),
            "data":funcfloat(funcs.datacall, "data", self),
            "frac":funcfloat(funcs.fractcall, "frac", self),
            "simp":funcfloat(funcs.simpcall, "simp", self),
            "floor":usefunc(math.floor, "floor", self, ["x"]),
            "ceil":usefunc(math.ceil, "ceil", self, ["x"]),
            "log":usefunc(math.log10, "log", self, ["x"]),
            "ln":usefunc(math.log, "ln", self, ["x"]),
            "sqrt":usefunc(isqrt, "sqrt", self, ["x"]),
            "tan":usefunc(math.tan, "tan", self, ["x"]),
            "sin":usefunc(math.sin, "sin", self, ["x"]),
            "cos":usefunc(math.cos, "cos", self, ["x"]),
            "atan":usefunc(math.atan, "atan", self, ["x"]),
            "asin":usefunc(math.asin, "asin", self, ["x"]),
            "acos":usefunc(math.acos, "acos", self, ["x"]),
            "deg":usefunc(math.degrees, "deg", self, ["x"]),
            "rad":usefunc(math.radians, "rad", self, ["x"]),
            "normdist":usefunc(normdist, "normdist", self, ["x", "mean", "stdev"]),
            "binomP":usefunc(binomP, "binomP", self, ["n", "p", "x"]),
            "hypgeoP":usefunc(hypgeoP, "hypgeoP", self, ["x", "n", "K", "N"]),
            "tdist":usefunc(tdist, "tdist", self, ["x", "df"]),
            "teq":usefunc(teq, "teq", ["df"], self, {"e":self}),
            "chisqdist":usefunc(chisqdist, "chisqdist", self, ["x", "df"]),
            "chisqeq":usefunc(chisqeq, "chisqeq", self, ["df"], {"e":self}),
            "normP":usefunc(normP, "normP", self, ["x", "y", "mean", "stdev"]),
            "tP":usefunc(tP, "tP", self, ["x", "y", "df"], {"e":self}),
            "chisqP":usefunc(chisqP, "chisqP", self, ["x", "df"], {"e":self}),
            "gamma":usefunc(gamma, "gamma", self, ["x"]),
            "gcd":usefunc(gcd, "gcd", self, ["x", "y"]),
            "lcm":usefunc(lcm, "lcm", self, ["x", "y", "maxtries"]),
            "perm":usefunc(perm, "perm", self, ["n", "k"]),
            "comb":usefunc(comb, "comb", self, ["n", "k"]),
            "i":complex(0.0, 1.0),
            "e":math.e,
            "pi":math.pi,
            "none":matrix(0),
